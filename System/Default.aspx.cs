...
public partial class System_Default : System.Web.UI.Page
{
    ...
    protected void AnalyseData_Click(object sender, EventArgs e)
    {
        ...
        for (int ctr = 0; ctr < 3; ctr++)
        {
            ...
            // table += " <tr><td>" + ctr + "</td><td>" + listA[ctr][0].ToString() + "</td><td>" + listA[ctr][1].ToString() + "</td><td>" + listA[ctr][2].ToString() + "</td><td>" + listA[ctr][3].ToString() + "</td><td>" + listA[ctr][4].ToString() + "</td><td>" + listA[ctr][5].ToString() + "</td></tr>";
        }
